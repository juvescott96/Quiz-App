...
function answer(selection){
    ...
    if(rightAnswerSelection(selectedQuestionNumber, question)){
        document.getElementById(selection).parentNode.classList.add('bg-success');
        rigtOfQuestions++;
        AUDIO_SUCCESS.play()
            setTimeout(() => {
                AUDIO_SUCCESS.pause();
                AUDIO_SUCCESS.currentTime = 0; // zurück zum Anfang setzen
            }, 3000);
    } else {
...
function rightAnswerSelection(selectedQuestionNumber, question){
